...
static const uint8_t usb_config0_descriptor[100] = {
        /* Configuration Descriptor */
		0x09,   		/* bLength: Configuration Descriptor size */
		0x02,  			/* bDescriptorType: Configuration */
		0x64, 0x00, 	/* wTotalLength: no of returned bytes */
        ...
        /* USB Microphone Input Terminal Descriptor - input from host */
		0x0C,       			/* bLength */
		0x24,      				/* bDescriptorType: audio descriptor type */
		0x02,         			/* bDescriptorSubtype: control input terminal */
		0x01,                   /* bTerminalID */
		0x01, 0x02,             /* wTerminal: microphone */
		0x00,                   /* bAssocTerminal */
		0x01,                   /* bNrChannels TODO: mono! */
