 ...
 * 
 * @brief STM32 Headers: SCB
 */

#ifndef STM32L476_SCB_H_
#define STM32L476_SCB_H_
...
typedef struct {
	...
	reg32_t RESERVED0[5];
	reg32_t CPACR;
} __attribute__((packed, aligned(4))) scb_t;

/* cCPUID Base Register */
...
#define SCB_ICSR_VECTPENDING				(0x01ff << 12)
#define SCB_ICSR_RETTOBASE					(1 << 11)
#define SCB_ICSR_VECTACTIVE					(0x01ff)
...
#define SCB_AIRCR_VECTKEYSTAT				(0x05FA << 16)
